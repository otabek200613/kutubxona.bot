...
async def bot_start(message: types.Message, state: FSMContext):
    ...
    if not subscribed:
        ...
        return  # agar obuna bo‘lmasa boshqa handlerlarga o‘tmaydi

    await message.answer("✔ Botdan foydalanishingiz mumkin!",reply_markup=start_button)
...
async def bot_start(message: types.Message):
    ...
    await message.answer_photo(photo="AgACAgIAAxkBAAIhEGknShIKoRcXlRbYH2yo-0kIvOIBAALaC2sbx65ASUpFZlZM4RkNAQADAgADeQADNgQ",caption=text)
...
@dp.message_handler(
    text=["""⭐️⭐️⭐️⭐️⭐️ | A'lo""", "⭐️⭐️⭐️⭐️️ | Yaxshi", "⭐️⭐️⭐️️️ | O'rtacha", "⭐️⭐️ | Qoniqarli", "⭐️ | Qoniqarsiz"])
...
async def zip(message: types.Message):
    fayllar = [
...
@dp.message_handler(text="🔄️ Yangi nashr")
